<header class="z-40 fixed w-screen top-0 py-4 flex bg-primary-100 shadow-md">
    <div id="logo" class="flex items-center ml-auto z-40">
        ...
        <a href="" class="flex items-center space-x-3 rtl:space-x-reverse px-5">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">ADIDAS STORE</span>
        </a>
    </div>
