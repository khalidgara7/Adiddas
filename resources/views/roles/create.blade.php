...
@section('content')
    <main id="main" class="pt-16 h-screen px-28">
        <h2 class="my-6 text-4xl font-semibold text-center font-poppins tracking-widest text-gray-700 dark:text-gray-200">
            <span class="text-primary-100 dark:text-orange">Add </span> a new role
        </h2>
            ...
            <div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                <div class="container mx-auto p-4">
                    <div class="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6">Here you can add role's information.</p>
                            ...
                            <div class="mb-4">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">
                                    Role Name
                                        ...
                                        @enderror
                                    <input type="text" id="name" name="name" placeholder="Role Name" class="border p-2 rounded w-full">
                                </label>
                            </div>

                            <div class="mb-4">
                                <button type="submit" class="px-4 py-2 bg-primary-100 rounded text-white hover:bg-blue-600 focus:outline-none transition-colors">Save role</button>
                                <a href="roles">
